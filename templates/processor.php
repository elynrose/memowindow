...
class TemplateProcessor {
    ...
    private function getMemoriesScripts() {
        ...
        import("./src/memories.js").then(module => {
            ...
            // Also initialize voice cloning
            import("./src/voice-clone.js").then(voiceModule => {
                console.log("✅ Voice clone module loaded successfully");
                voiceModule.initVoiceClone();
            }).catch(voiceError => {
                console.error("❌ Failed to load voice clone module:", voiceError);
            });
        }).catch(error => {
